            ...
            switch (action) {
                ...
                case 2:
                    if (forward) {
                        ...
                        if (listIterator.hasPrevious()) {
                            System.out.println("now plau=ying " + listIterator.previous().toString());
                        } else {
                ...
                case 3:
                    if (forward) {
                        if (listIterator.hasPrevious()) {
                            ...
                            System.out.println("we are at he start of the list");
                        }
                    } else {
                        if (listIterator.hasNext()) {
                            System.out.println("now playing" + listIterator.next().toString());
                            ...
                            System.out.println("we have reached to the end od List");
                        }
                    }
                            break;
                        case 4:
